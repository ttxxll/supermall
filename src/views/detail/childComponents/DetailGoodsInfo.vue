...
export default {
  ...
  //Detail中detailInfo默认是一个空对象{}，最开始还没请求到数据时，会将这个空对象传给子组件DetailGoodsInfo，得到的list的长度就会是0
  //所以我们需要在detailInfo请求到数据后，再获取其中的list的长度：watch可以监听某个属性的变化，比如detailInfo对象的变化，当其变化时，为imagesLengeth赋值。
  watch: {
    detailInfo() {
